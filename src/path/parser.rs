...
use {Error, Path, PathSegment, Result, Stream};
...
mod tests {
    ...
    test!(
        move_to_4,
        "M 10 20 30 40 50 60 M 70 80 90 100 110 120",
        PathSegment::MoveTo {
            abs: true,
            x: 10.0,
            y: 20.0
    ...
    test!(
        separator_1,
        "M 10 20 L 5 15 C 10 20 30 40 50 60",
        PathSegment::MoveTo {
            abs: true,
            x: 10.0,
            y: 20.0
    ...
    test!(
        separator_4,
        "M10, 20 L5, 15 C10, 20 30 40 50 60",
        PathSegment::MoveTo {
            abs: true,
            x: 10.0,
            y: 20.0
    ...
    test!(
        close_path_1,
        "M10 20 L 30 40 ZM 100 200 L 300 400",
        PathSegment::MoveTo {
            abs: true,
            x: 10.0,
            y: 20.0
